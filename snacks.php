...
$sql = "SELECT * FROM produtos WHERE categoria='snacks'";
...
<div class="caixa-botao">
  <input type="button" onclick="irParaPagina('pizzaria.php')" value="<<"></a>
  <input type="button" onclick="irParaPagina('massas.php')" value=">>"></a>
