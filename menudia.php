...
<br><br>
<div class="slideshow">
  <img class="slide" src="car-seg.jpeg" style="width:10%">
  <img class="slide" src="faia-ter.jpeg" style="width:10%">
  <img class="slide" src="pinho-qua.jpeg" style="width:10%">
  <img class="slide" src="cedro-qui.jpeg" style="width:10%">
  <img class="slide" src="pau-sex.jpeg" style="width:10%">
...
$sql = "SELECT * FROM produtos WHERE categoria='menudia'";
...
<div class="caixa-botao">
  <input type="button"  onclick="irParaPagina('bebidas.php')" value="<<">
  <input type="button" onclick="irParaPagina('sobremesas.php')" value=">>">
</div>
<br>
<style>
 body {
